 ...
 *                            "ClassName.method"
 * @param {Array.<string>} [args2]   Zero or more arguments to pass to the method
...
var Contact = function(id, displayName, name, nickname, phoneNumbers, emails, addresses,
    ...
    this.phoneNumbers = phoneNumbers || null; // Array.<ContactField>
    this.emails = emails || null; // Array.<ContactField>
    this.addresses = addresses || null; // Array.<ContactAddress>
    this.ims = ims || null; // Array.<ContactField>
    this.organizations = organizations || null; // Array.<ContactOrganization>
    this.birthday = birthday || null; // JS Date
    this.note = note || null;
    this.photos = photos || null; // Array.<ContactField>
    this.categories = categories || null; 
    this.urls = urls || null; // Array.<ContactField>
};
